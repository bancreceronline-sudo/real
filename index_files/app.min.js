    ...
    $.ajax({
        ...
        beforeSend: function () {
            ...
            if ($.navAsAjax && $(".google_maps")[0] && (container[0] == $("#content")[0])) {
                ...
                // debugState
                if (debugState) {
                    root.console.log("âœ” Google map instances nuked!!!");
                }
            ...
            if ($.navAsAjax && $('.dataTables_wrapper')[0] && (container[0] == $("#content")[0])) {
                ...
                // debugState
                if (debugState) {
                    root.console.log("âœ” Datatable instances nuked!!!");
                }
            }
            // end destroy
            ...
            if ($.navAsAjax && $.intervalArr.length > 0 && (container[0] == $("#content")[0]) && enableJarvisWidgets) {
                ...
                // debugState
                if (debugState) {
                    root.console.log("âœ” All JarvisWidget intervals cleared");
                }
            ...
            if ($.navAsAjax && (container[0] == $("#content")[0]) && enableJarvisWidgets && $("#widget-grid")[0]) {
                ...
                // debugState
                if (debugState) {
                    root.console.log("âœ” JarvisWidgets destroyed");
                }
            ...
            if ($.navAsAjax && (container[0] == $("#content")[0])) {
                ...
                if (typeof pagedestroy == 'function') {
                    ...
                    try {
                        ...
                        if (debugState) {
                            root.console.log("âœ” Pagedestroy()");
                        }
                    }
                    catch (err) {
                ...
                if ($.fn.sparkline && $("#content .sparkline")[0]) {
                    ...
                    if (debugState) {
                        root.console.log("âœ” Sparkline Charts destroyed!");
                    }
                }
                ...
                if ($.fn.easyPieChart && $("#content .easy-pie-chart")[0]) {
                    ...
                    if (debugState) {
                        root.console.log("âœ” EasyPieChart Charts destroyed!");
                    }
                }
                ...
                if ($.fn.select2 && $("#content select.select2")[0]) {
                    ...
                    if (debugState) {
                        root.console.log("âœ” Select2 destroyed!");
                    }
                }
                ...
                if ($.fn.mask && $('#content [data-mask]')[0]) {
                    ...
                    if (debugState) {
                        root.console.log("âœ” Input Mask destroyed!");
                    }
                }
                ...
                if ($.fn.datepicker && $('#content .datepicker')[0]) {
                    ...
                    if (debugState) {
                        root.console.log("âœ” Datepicker destroyed!");
                    }
                }
                ...
                if ($.fn.slider && $('#content .slider')[0]) {
                    ...
                    if (debugState) {
                        root.console.log("âœ” Bootstrap Slider destroyed!");
                    }
                }
